              ...
              {allIcons.map((iconResult, index) => {
                ...
                return (
                  <button
                    ...
                    className="p-3 rounded-lg border-2 border-gray-200 transition-all hover:scale-105 hover:shadow-md hover:border-blue-300 hover:bg-blue-50 flex flex-col items-center gap-1 min-h-[70px]"
